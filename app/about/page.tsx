  ...
  return (
    <main className="py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-5xl font-bold text-primary-700 mb-8">About Business e011d6f4-9ac5-4594-8a63-90ee5c5296db</h1>

        <div className="prose prose-lg">
          <p className="text-xl text-gray-700 mb-6">
            With over two decades of experience in business-e011d6f4-9ac5-4594-8a63-90ee5c5296db, we've built our reputation on
          ...
          <p className="text-gray-700">
            To provide our clients with trusted, reliable business-e011d6f4-9ac5-4594-8a63-90ee5c5296db services that exceed expectations
          ...
          <div className="bg-primary-50 p-8 rounded-lg mt-12">
            ...
            <p className="text-gray-700">
              Ready to work with a trusted business-e011d6f4-9ac5-4594-8a63-90ee5c5296db partner? Contact us today to discuss your needs.
            </p>
